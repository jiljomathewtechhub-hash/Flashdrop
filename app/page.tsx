  ...
  return (
    <main>
      ...
      <header className="nav-wrap">
        ...
        <a className="nav-call" href="tel:+16478070287"><small>Call us now</small><strong>+1 (647) 807-0287</strong></a>
      </header>
        ...
        <div className="hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              ...
              <a className="button ghost" href="tel:+16476280694">Call (647) 628-0694</a>
            </div>
            <div className="quick-points"><span>✓ Same-day</span><span>✓ Next-day</span><span>✓ On-time</span></div>
          </div>
          <div className="hero-visual">
            <div className="red-slice"></div>
            <img src="/flashdrop-card.jpeg" alt="FlashDrop Express delivery van and contact card" />
